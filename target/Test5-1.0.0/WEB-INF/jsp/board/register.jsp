...
<br/>
<div class="container">
        <form id="form_test" action="insertTest.do" method="post" encType="multiplart/form-data">
            ...
            <table class="table table-bordered">
                <tbody>
                    ...
                    <tr>
                    	<th>첨부파일</th>
			            <td><input name="file_1" id="egovComFileUploader" type="file" class="files form-control form-control-sm" />
